...
<nav className="bg-slate-100 border-gray-200 dark:bg-gray-900">
  ...
  <Link to='/profile'>
    ...
    <div className="items-center justify-between  w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-slate-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-slate-100 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        {/* <li>
