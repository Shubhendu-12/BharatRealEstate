...
const About = () => {
  return (
   ...
   <div className='max-w-5xl flex flex-col gap-5'>
    <p>At <span className='font-semibold'> Rentify </span> , we understand that finding the perfect property is not just about location; it's about discovering a place that truly feels like home. With a commitment to excellence and a passion for helping you find your dream property, we take pride in being your trusted partner in the real estate journey.</p>
