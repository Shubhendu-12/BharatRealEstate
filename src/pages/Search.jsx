...
const Search = () => {
    ...
    const fetchListings = async ()=>{
        try {
            ...
            const res = await fetch(`http://localhost:3000/api/listing/getAllListing?${searchQuery}`);
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row mt-8 max-w-7xl mx-auto md:min-h-screen max-lg:mx-6 ">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-6 mt-4 max-w-4xl items-center justify-center">
         {/* Loading skeleton */}
     {loading && (
<div role="status" className=" mt-2 mx-2 space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
  ...
  <p className="text-2xl mx-5 my-4 text-slate-800">No Listing found! </p> )}
