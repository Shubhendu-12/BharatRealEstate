...
<div role="status" className=" mt-2 mx-2 space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
    ...
    <span className="sr-only">Loading...</span>
      ...
      <div className=" my-8 flex flex-col mx-auto max-w-4xl max-sm:mx-4  max-md:mx10 max-lg:mx-20 justify-center ">
        ...
        {listing?.offer && <p>
        {listing.offer === true && (
          <button type="button" className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">₹{' '}{+listing.regularPrice.toLocaleString('en-IN') - +listing.discountedPrice.toLocaleString('en-IN')}  discount</button>
